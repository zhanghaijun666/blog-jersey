...
UploadFile.prototype.sendUplodFile = function () {
    var self = this;
    console.log(self);
    getRequest("/uploadfile/default/" + bcstore.GtypeEnum.User + "/" + RootView.user().userId + "/directory/" + self.file.name, {method: "POST", type: "application/x-protobuf", accept: "application/x-protobuf", data: self.file}, function (data) {
