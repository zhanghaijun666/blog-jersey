function PageUtils(root) {
    ...
    self.blogNavigator = function () {
        let arr = [];
        arr.push(new MenuTab('我的博客', {icon: 'fa-book', isActive: true, click: self.changeHash.bind(null, "menu")}));
        ...
        if (self.isSmallScreen()) {
            arr.push(new MenuTab('我的', {icon: 'fa-home', isActive: false, click: self.changeHash.bind(null, "menu")}));
        }
        return arr;
    };
    self.PersonalCenter = [
