...
public final class SimpleContainerFactory2 {
    ...
    private SimpleContainerFactory2() {
    }
    ...
    public static SimpleServer create(final URI address, final ResourceConfig config, final int count,
                                      final int select) {
        return create(address, null, new SimpleContainer2(config), count, select);
    }
    ...
    public static SimpleServer create(final URI address, final SSLContext context,
        ...
        return create(address, context, new SimpleContainer2(config));
    }
    ...
    public static SimpleServer create(final URI address, final SSLContext context,
        ...
        return create(address, context, new SimpleContainer2(config), count, select);
    }
    ...
    public static SimpleServer create(final URI address, final SSLContext context,
                                      ...
                                      final int select) {
        return create(address, context, new SimpleContainer2(config, parentContext), count, select);
    }
     ...
     */
    public static SimpleServer create(final URI address, final SSLContext context,
                                      final SimpleContainer2 container, final int count, final int select)
