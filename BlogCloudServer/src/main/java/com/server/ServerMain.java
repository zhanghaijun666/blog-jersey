...
import com.server.filter.BlogRequestFilter;
import com.server.filter.BlogResponseFilter;
...
public class ServerMain {
    ...
    public static SimpleServer startServer() {
        ...
        resourceConfig.register(BlogRequestFilter.class);
        resourceConfig.register(BlogResponseFilter.class);
